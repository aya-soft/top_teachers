...
| [COMM-020]  |              | Оставляем                                                               |                                 |                                                                                                        |
|             |              |                                                                         |                                 |                                                                                                        |
| [COMM-030]  | Синхронная   | Асинхронная отправка события через kafka                                | 10, 40, 50, 60, 80, 100         | Создает ненужный coupling, нагружает Сервисы Найма иЗаданий, мгновенно не нужно, результат не нужен    |
|             |              | Событие "Решение одобрено"                                              |                                 |                                                                                                        |
|             |              |                                                                         |                                 |                                                                                                        |
| [COMM-040]  | Синхронная   | Асинхронная отправка события через kafka                                | 10, 30, 40, 50, 70, 80, 90, 100 | Создает ненужный coupling, нагружает Сервисы Найма и Бонусов, мгновенно не нужно, результат не нужен   |
|             |              | Событие "Решение одобрено", рейтинг внутри события                      |                                 |                                                                                                        |
|             |              |                                                                         |                                 |                                                                                                        |
| [COMM-050]  | Синхронная   | Асинхронная отправка события через kafka                                | 10, 30, 40, 50, 80, 90, 100     | Создает ненужный coupling, нагружает Сервисы Найма и Бонусов, мгновенно не нужно, результат не нужен   |
|             |              | Событие "Решение забраковано", рейтинг внутри события                   |                                 |                                                                                                        |
|             |              |                                                                         |                                 |                                                                                                        |
|             |              |                                                                         |                                 |                                                                                                        |
| [COMM-060]  | Асинхронная  | Асинхронная отправка события через kafka                                | 10, 30, 40, 50, 70              | Бесполезное событие, которое в связке с синхронной операцией тормозит                                  |
|             |              | Меняем событие TaskRating на 2 события:                                 |                                 |                                                                                                        |
|             |              | "Решение одобрено" и "Решение забраковано"                              |                                 |                                                                                                        |
|             |              | Внутри событий передаем рейтинг задания.                                |                                 |                                                                                                        |
|             |              |                                                                         |                                 |                                                                                                        |
| [COMM-070]  | Синхронная   | Оставляем, но уточнить направление (на схеме и в описании не совпадают) |                                 | (Правильно: Из Сервиса Бонусов в Сервис Заданий) Сервис Заданий не должен знать о Сервисе Бонусов      |
|             |              |                                                                         |                                 |                                                                                                        |
| [COMM-080]  | Синхронная   | Асинхронная отправка события через kafka                                | 60, 80, 90                      | Создает ненужный coupling, нагружает Сервисы Заданий и Бонусов, мгновенно не нужно, результат не нужен |
|             |              | Событие "Задание создано"                                               |                                 |                                                                                                        |
|             |              |                                                                         |                                 |                                                                                                        |
| [COMM-090]  | Синхронная   | Оставляем, но уточнить направление (на схеме и в описании не совпадают) |                                 | (Правильно: Из Сервиса Заданий в Сервис Найма) Эти сервисы логически связаны.                          |
